...
##
"""
py-postgresql_bu system functions and data.
...
---------------------
 ...
 excformat
  ...
  Effectively, the implementation of `postgresql_bu.exception.Error.__str__`
...
def errformat(*args, **kw):
	...
	Override if you like. All postgresql_bu.exceptions.Error's are formatted using
	this function.
	"""
