...
postgresql_bu.cluster provides a programmer's interface to controlling a PostgreSQL
...
DEFAULT_CONFIG_FILENAME = 'postgresql_bu.conf'
...
class Cluster(pg_api.Cluster):
	...
	def connector(self, **kw):
		"""
		Create a postgresql_bu.driver connector based on the given keywords and
