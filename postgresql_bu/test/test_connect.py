...
class TestCaseWithCluster(unittest.TestCase):
	"""
	postgresql_bu.driver *interface* tests.
	"""
...
class test_connect(TestCaseWithCluster):
	"""
	postgresql_bu.driver connectivity tests
	"""
	ip6 = '::1'
	ip4 = '127.0.0.1'
	host = 'localhost'
...
-- http://www.postgresql_bu.org/docs/8.2/interactive/auth-methods.html#AUTH-PASSWORD
