...
class Box(tuple):
	...
	http://www.postgresql_bu.org/docs/current/static/datatype-geometric.html

		>>> Box(( (0,0), (-2, -2) ))
		postgresql_bu.types.geometry.Box(((0.0, 0.0), (-2.0, -2.0)))

	It will also relocate values to enforce the high-low expectation:

		>>> t.box(((-4,0),(-2,-3)))
		postgresql_bu.types.geometry.Box(((-2.0, 0.0), (-4.0, -3.0)))
