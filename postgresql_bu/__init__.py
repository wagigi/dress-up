##
# py-postgresql_bu root package
# http://python.projects.postgresql.org
##
"""
py-postgresql_bu is a Python package for using PostgreSQL. This includes low-level
protocol tools, a driver(PG-API and DB-API), and cluster management tools.

If it's not documented in the narratives, `postgresql_bu.documentation.index`, then
the stability of the APIs should *not* be trusted.

See <http://postgresql_bu.org> for more information about PostgreSQL.
"""
__all__ = [
	'__author__',
	'__date__',
...
#: The version string of py-postgresql_bu.
version = '' # overridden by subsequent import from .project.

#: The version triple of py-postgresql_bu: (major, minor, patch).
...
def open(iri = None, prompt_title = None, **kw):
    ...
    `iri`::
        ...
        >>> db = postgresql_bu.open('localhost/postgres')
